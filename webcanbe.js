...
(() => {
  ...
  const curateHome = () => {
    ...
    const serviceImages = [
      ...
      ['assets/portfolio-mason-reed.png', 'Mason Reed personal-brand website example', '50% 0%'],
      ['assets/portfolio-maeve.jpg', 'MAEVE creator-brand and commerce website example', '50% 0%'],
  ...
  const refineCreatorBusinessSections = () => {
    ...
    document.querySelectorAll('[data-framer-name="Section | Services"]').forEach((section) => {
      const serviceExamples = [
        ...
        { category: 'PERSONAL BRAND WEBSITE', headline: 'PERSONAL BRAND', description: 'Expertise, content, products and services built around one recognizable personal brand.', features: ['Expertise and positioning', 'Content and resource structure', 'Courses, products and services', 'Advisory inquiry paths', 'Responsive development'], project: 'MASON REED', url: 'https://webcanbe-mason-reed.vercel.app/', image: 'assets/portfolio-mason-reed.png', objectPosition: '50% 0%', alt: 'MASON REED personal-brand website example' },
        { category: 'CREATOR BRAND / COMMERCE', headline: 'CREATOR COMMERCE', description: 'Editorial storytelling, campaigns and products for creator-owned brands.', features: ['Editorial art direction', 'Campaign and collection stories', 'Product and commerce paths', 'Collaboration inquiries', 'Responsive development'], project: 'MAEVE', url: 'https://webcanbe-maeve.vercel.app/', image: 'assets/portfolio-maeve.jpg', objectPosition: '50% 0%', alt: 'MAEVE creator-brand and commerce website example' },
